...
(() => {
  ...
  class CardBuilder {
    ...
    buildEditableTitle(content, editType, centerAlign = true) {
      ...
      return `
        <div class="editable-section" data-section-type="html">
          <h4 style="${style}" class="editable editable-title${spellTitleClass}" data-edit-type="generic" data-edit-section="${this.data.nom}">${content}</h4>
    ...
    buildEditableField(content, editType, label, options = {}) {
      ...
      return `
        <div class="editable-section" data-section-type="html">
          <div class="editable ${className}" data-edit-type="generic" data-edit-section="${this.data.nom}" ${style}>
            ${content}
          </div>
    ...
    buildEditableEffect(content, editType, label) {
      return `
        <div class="editable-section" data-section-type="html">
          <div class="editable editable-effect" data-edit-type="generic" data-edit-section="${this.data.nom}" style="margin: 1rem 0;">
            ${content}
          </div>
...
// console.warn('Found array format for capacites, converting to HTML:', items);
      ...
      return `
        <h5>${label}</h5>
        <div class="editable-section" data-section-type="html">
          <div class="editable" data-edit-type="generic" data-edit-section="${this.data.nom}">
            ${listHTML}
          </div>
    ...
    buildStatsSection() {
      ...
      return `
        <div class="editable-section" data-section-type="html">
          <div class="editable editable-stats" data-edit-type="generic" data-edit-section="${this.data.nom}">
            ${statsHTML}
          </div>
