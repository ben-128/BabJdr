  ...
  class UnifiedEditor {
    ...
    parseHtmlEditContext(element, editSection) {
      ...
      if (monsterCard) {
        ...
        // Use index-based detection for monster sections
        const allEditables = Array.from(monsterCard.querySelectorAll('.editable'));
        const editableElement = element.classList.contains('editable') ? element : element.querySelector('.editable');
        const currentIndex = allEditables.indexOf(editableElement);
        
        // Map index to monster property based on CardBuilder order
        // 0=nom, 1=tags, 2=element, 3=pointsDeVie, 4=armurePhysique, 5=esquive, 6=coupCritique, 7=coupCritiqueSorts, 8=resistanceAlterations, 
        // 9=armureFeu, 10=armureEau, 11=armureTerre, 12=armureAir, 13=armureLumiere, 14=armureObscurite, 15=armureDivin, 16=armureMalefique, 17=abilites, 18=butin
        const monsterSections = [
          'nom', 'tags', 'element', 'pointsDeVie', 'armurePhysique', 'esquive', 'coupCritique', 'coupCritiqueSorts', 'resistanceAlterations',
          'armureFeu', 'armureEau', 'armureTerre', 'armureAir', 'armureLumiere', 'armureObscurite', 'armureDivin', 'armureMalefique',
          'abilites', 'butin'
        ];
        const monsterEditSection = monsterSections[currentIndex] || 'abilites';
        ...
        return {
          ...
          property: 'html',
          editType: 'html', 
          editSection: monsterEditSection,
