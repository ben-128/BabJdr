      ...
      return `
        <div class="card editable-section" data-section-type="monster" data-monster-name="${this.data.nom}">
          ...
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.5rem; margin: 1rem 0; font-size: 0.9em;">
            <div><strong>❤️ PV:</strong> <span class="editable" data-edit-type="generic" data-edit-section="monster-pointsdevie" data-item-identifier="${this.data.nom}">${this.data.pointsDeVie}</span></div>
            <div><strong>🛡️ Armure:</strong> <span class="editable" data-edit-type="generic" data-edit-section="monster-armurephysique" data-item-identifier="${this.data.nom}">${this.data.armurePhysique}</span></div>
            <div><strong>🏃 Esquive:</strong> <span class="editable" data-edit-type="generic" data-edit-section="monster-esquive" data-item-identifier="${this.data.nom}">${this.data.esquive}</span></div>
            <div><strong>⚡ Critique:</strong> <span class="editable" data-edit-type="generic" data-edit-section="monster-coupcritique" data-item-identifier="${this.data.nom}">${this.data.coupCritique}</span></div>
            <div><strong>🔮 Crit. Sorts:</strong> <span class="editable" data-edit-type="generic" data-edit-section="monster-coupcritiquesorts" data-item-identifier="${this.data.nom}">${this.data.coupCritiqueSorts}</span></div>
            <div><strong>🛡️ Rés. Alt.:</strong> <span class="editable" data-edit-type="generic" data-edit-section="monster-resistancealterations" data-item-identifier="${this.data.nom}">${this.data.resistanceAlterations}</span></div>
          </div>
          ...
          <div style="margin: 1rem 0;">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 0.25rem; font-size: 0.8em; margin-top: 0.5rem;">
              <div>🔥 <span class="editable" data-edit-type="generic" data-edit-section="monster-armurefeu" data-item-identifier="${this.data.nom}">${this.data.armureFeu}</span></div>
              <div>💧 <span class="editable" data-edit-type="generic" data-edit-section="monster-armureeau" data-item-identifier="${this.data.nom}">${this.data.armureEau}</span></div>
              <div>🌍 <span class="editable" data-edit-type="generic" data-edit-section="monster-armureterre" data-item-identifier="${this.data.nom}">${this.data.armureTerre}</span></div>
              <div>💨 <span class="editable" data-edit-type="generic" data-edit-section="monster-armureair" data-item-identifier="${this.data.nom}">${this.data.armureAir}</span></div>
              <div>✨ <span class="editable" data-edit-type="generic" data-edit-section="monster-armurelumiere" data-item-identifier="${this.data.nom}">${this.data.armureLumiere}</span></div>
              <div>🌑 <span class="editable" data-edit-type="generic" data-edit-section="monster-armureobscurite" data-item-identifier="${this.data.nom}">${this.data.armureObscurite}</span></div>
            </div>
          </div>
          ...
          ${this.data.abilites ? `
            ...
            <div class="editable" data-edit-type="generic" data-edit-section="monster-abilites" data-item-identifier="${this.data.nom}">${this.data.abilites}</div>
          ` : ''}

          ${this.data.butin ? `
            <hr style="margin: 1rem 0; border: none; border-top: 1px solid var(--rule);">
            <div><strong>💰 Butin:</strong></div>
            <div class="editable" data-edit-type="generic" data-edit-section="monster-butin" data-item-identifier="${this.data.nom}">${this.data.butin}</div>
          ` : ''}
