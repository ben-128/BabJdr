  ...
  class TablesTresorsManager {
    ...
    saveFourchette() {
      try {
        ...
        console.log('TablesTresorsManager: Sauvegarde fourchette', { tableName, fourchetteIndex, isNewFourchette, newFourchette });
        this.saveToStorage();
        console.log('TablesTresorsManager: Tentative de rafraîchissement de la page');
        this.refreshTablesTresorsPage();
        this.closeAllModals();
        
        console.log('TablesTresorsManager: Fourchette sauvegardée avec succès');
    ...
    refreshTablesTresorsPage() {
      ...
      console.log('TablesTresorsManager: refreshTablesTresorsPage appelée');
      console.log('TablesTresorsManager: Route actuelle:', JdrApp.modules.router ? JdrApp.modules.router.getCurrentRoute() : 'router non disponible');
      
      if (JdrApp.modules.router && JdrApp.modules.router.getCurrentRoute() === 'tables-tresors') {
        console.log('TablesTresorsManager: Rafraîchissement en cours via navigate...');
        // Force complete page regeneration via router navigation
        JdrApp.modules.router.navigate('tables-tresors');
        console.log('TablesTresorsManager: Navigation déclenchée');
      } else {
        console.log('TablesTresorsManager: Pas sur la page tables-tresors, rafraîchissement ignoré');
      }
    }
