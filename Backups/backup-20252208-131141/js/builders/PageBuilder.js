...
(() => {
  ...
  class PageBuilder {
    ...
    buildIdSearchFilter() {
      return `
        <div class="id-search-filter" style="margin: 1rem 0; padding: 1rem; background: var(--card); border: 2px solid var(--rule); border-radius: 12px;">
          <div style="display: flex; align-items: center; gap: 1rem; flex-wrap: wrap;">
            ...
            <div style="display: flex; align-items: center; gap: 0.5rem; flex: 1; min-width: 200px;">
              <input 
                ...
                style="flex: 1; padding: 0.5rem; border: 1px solid var(--rule); border-radius: 6px; font-size: 1em;"
              >
              <button 
                id="clear-id-search" 
                class="btn small" 
                style="background: var(--bronze); color: white; padding: 0.5rem 1rem; white-space: nowrap;"
          ...
          <div id="id-search-result" style="margin-top: 0.5rem; font-size: 0.9em; color: var(--paper-muted); min-height: 1.2em;">
