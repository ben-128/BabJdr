    ...
    createEtatsModal() {
      ...
      const modal = JdrApp.utils.dom.create('div', 'modal etats-modal', `
        <div class="modal-content etats-modal-content">
          ...
          <p>Cliquez sur un état pour générer un lien avec prévisualisation.</p>
      ...
      modal.addEventListener('click', (e) => {
        ...
        if (etatItem) {
          ...
          // Utiliser insertTextAtCursor si on est dans l'éditeur HTML, sinon copier dans le presse-papiers
          if (window.editorInsertTextAtCursor) {
            window.editorInsertTextAtCursor(etatLink);
          } else {
