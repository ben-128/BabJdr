...
(() => {
  ...
  class CardBuilder {
    ...
    buildEditableTitle(content, editType, centerAlign = true) {
      ...
      return `
        <div class="editable-section" data-section-type="${editType}">
          <h4 style="${style}" class="editable editable-title" data-edit-type="${editType}" data-edit-section="${this.data.nom}">${content}</h4>
    ...
    buildEditableField(content, editType, label, options = {}) {
      ...
      return `
        <div class="editable-section" data-section-type="${editType}">
          <div class="editable ${className}" data-edit-type="${editType}" data-edit-section="${this.data.nom}" ${style}>
            ${content}
          </div>
    ...
    buildEditableEffect(content, editType, label) {
      return `
        <div class="editable-section" data-section-type="${editType}">
          <div class="editable editable-effect" data-edit-type="${editType}" data-edit-section="${this.data.nom}" style="margin: 1rem 0;">
            ${content}
          </div>
    ...
    buildEditableList(items, editType, label) {
      return `
        <h5>${label}</h5>
        <div class="editable-section editable-list-container" data-section-type="${editType}">
          <ul class="editable editable-list" data-edit-type="${editType}" data-edit-section="${this.data.nom}">
    ...
    buildStatsSection() {
      return `
        <div class="editable-section" data-section-type="subclass-stats">
          <div class="editable editable-stats" data-edit-type="subclass-stats" data-edit-section="${this.data.nom}">
            <div class="chips">
