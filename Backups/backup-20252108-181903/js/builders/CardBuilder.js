...
// console.warn('Found array format for capacites, converting to HTML:', items);
    ...
    buildSpellElement() {
      ...
      // Always generate both versions - CSS controls visibility via body.dev-on/dev-off
      ...
      return `
        <div style="text-align: center; margin: 0.5rem 0;">
          <!-- Dev mode selector (hidden by CSS when dev-off) -->
          ...
          <!-- Display mode (hidden by CSS when dev-on) -->
