  ...
  window.ContentTypes = {
    ...
    monster: {
      fields: {
        ...
        coupCritiqueSorts: { type: 'number', label: 'Coup critique sorts', required: true },
        ...
        abilites: { type: 'textarea', label: 'Abilités', required: false },
        butin: { type: 'textarea', label: 'Butin', required: false }
      },
      editMapping: {
        'monster-name': 'nom',
        'monster-image': 'image',
      ...
      filterConfig: {
        availableTags: [
          "Basique", "Elite", "Boss", "Animal", "Mort-vivant", "Démon", 
          "Dragon", "Humanoïde", "Magique", "Construct", "Feu", "Eau", 
          "Terre", "Air", "Lumière", "Obscurité", "Volant", "Aquatique", 
          "Souterrain", "Nocturne"
        ],
        defaultVisibleTags: ["Basique"]
      },
      defaultValues: {
        nom: "Nouveau Monstre",
        image: "",
