...
(() => {
  ...
  class UnifiedEditor {
    ...
    updateMonsterData(session, content) {
      ...
      console.log('🔍 DEBUG: Updating monster', monster.nom, 'property', propertyName, 'from', monster[propertyName], 'to', content);
      monster[propertyName] = content;
      console.log('🔍 DEBUG: Monster after update:', monster);
      return true;
    }
