...
(() => {
  ...
  JdrApp.modules.router = {
    ...
    renderFeuillePersonnagePage() {
      ...
      const feuillePersonnageContent = `
        <div class="page-header">
          ...
          <p>Créez et générez des feuilles de personnage PDF complètes pour vos héros.</p>
        </div>
        
        <div class="character-sheet-generator">
          <div class="generator-sections">
            ...
            <section class="info-section">
              ...
              <div class="form-grid">
                <div class="form-group">
                  ...
                  <input type="text" id="char-name" placeholder="Ex: Aelron le Brave">
                </div>
                <div class="form-group">
                  <label for="char-player">Nom du joueur :</label>
                  <input type="text" id="char-player" placeholder="Ex: Marie">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="char-class">Classe principale :</label>
                ...
                <div class="form-group">
                  <label for="char-subclass">Sous-classe :</label>
                  <input type="text" id="char-subclass" placeholder="Ex: Berserker, Chasseur...">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="char-exp">Points d'expérience :</label>
                  <input type="number" id="char-exp" min="0" value="0">
                </div>
                <div class="form-group">
                  <label for="char-background">Historique :</label>
                  <textarea id="char-background" placeholder="Histoire et background du personnage..." rows="3"></textarea>
                </div>
              </div>
            </section>
            ...
            <section class="stats-section">
              ...
              <div class="stats-grid">
                <div class="stat-group">
                  <label for="stat-force">💪 Force :</label>
                  <input type="number" id="stat-force" min="1" max="20" value="10">
                </div>
                <div class="stat-group">
                  <label for="stat-agilite">🏃 Agilité :</label>
                  <input type="number" id="stat-agilite" min="1" max="20" value="10">
                </div>
                <div class="stat-group">
                  <label for="stat-endurance">🛡️ Endurance :</label>
                  <input type="number" id="stat-endurance" min="1" max="20" value="10">
                </div>
                <div class="stat-group">
                  <label for="stat-intelligence">🧠 Intelligence :</label>
                  <input type="number" id="stat-intelligence" min="1" max="20" value="10">
                </div>
                <div class="stat-group">
                  <label for="stat-volonte">⚡ Volonté :</label>
                  <input type="number" id="stat-volonte" min="1" max="20" value="10">
                </div>
                <div class="stat-group">
                  <label for="stat-chance">🍀 Chance :</label>
                  <input type="number" id="stat-chance" min="1" max="20" value="10">
                </div>
              </div>
            </section>
            ...
            <section class="resources-section">
              <h2>💎 Ressources et combat</h2>
              <div class="form-grid">
                <div class="form-group">
                  <label for="char-pv-max">❤️ Points de vie maximum :</label>
                  <input type="number" id="char-pv-max" min="1" value="20">
                </div>
                <div class="form-group">
                  <label for="char-pv-current">❤️ Points de vie actuels :</label>
                  <input type="number" id="char-pv-current" min="0" value="20">
                </div>
                <div class="form-group">
                  <label for="char-mana-max">🔵 Points de mana maximum :</label>
                  <input type="number" id="char-mana-max" min="0" value="10">
                </div>
                <div class="form-group">
                  <label for="char-mana-current">🔵 Points de mana actuels :</label>
                  <input type="number" id="char-mana-current" min="0" value="10">
                </div>
                <div class="form-group">
                  <label for="char-armure">🛡️ Armure physique :</label>
                  <input type="number" id="char-armure" min="0" value="2">
                </div>
                <div class="form-group">
                  <label for="char-esquive">🌪️ Esquive :</label>
                  <input type="number" id="char-esquive" min="0" value="5">
                </div>
                <div class="form-group">
                  <label for="char-critique">💥 Coup critique :</label>
                  <input type="number" id="char-critique" min="0" value="10">
                </div>
                <div class="form-group">
                  <label for="char-critique-sorts">✨ Critique sorts :</label>
                  <input type="number" id="char-critique-sorts" min="0" value="8">
                </div>
                <div class="form-group">
                  <label for="char-resistance">✨ Résistance altérations :</label>
                  <input type="number" id="char-resistance" min="0" value="3">
                </div>
              </div>
            </section>

            <!-- Section Compétences et Dons -->
            <section class="skills-section">
              <h2>🎖️ Compétences et Dons</h2>
              <div class="form-group">
                <label for="char-capacites">🏆 Capacités spéciales :</label>
                <textarea id="char-capacites" placeholder="Listez les capacités, talents spéciaux..." rows="4"></textarea>
              </div>
              <div class="form-group">
                <label for="char-dons">🎖️ Dons acquis :</label>
                <textarea id="char-dons" placeholder="Listez tous les dons du personnage..." rows="4"></textarea>
              </div>
              <div class="form-group">
                <label for="char-sorts">🔮 Sorts connus :</label>
                <textarea id="char-sorts" placeholder="Listez tous les sorts maîtrisés..." rows="4"></textarea>
              </div>
            </section>
            ...
            <section class="equipment-section">
              ...
              <div class="form-grid">
                <div class="form-group">
                  <label for="char-armes">⚔️ Armes :</label>
                  <textarea id="char-armes" placeholder="Épées, arcs, bâtons..." rows="3"></textarea>
                </div>
                <div class="form-group">
                  <label for="char-armures">🛡️ Armures et protection :</label>
                  <textarea id="char-armures" placeholder="Armures, boucliers, robes..." rows="3"></textarea>
                </div>
                <div class="form-group">
                  <label for="char-objets">📦 Objets et consommables :</label>
                  <textarea id="char-objets" placeholder="Potions, herbes, objets magiques..." rows="3"></textarea>
                </div>
                <div class="form-group">
                  <label for="char-richesses">💰 Richesses :</label>
                  <input type="text" id="char-richesses" placeholder="Ex: 150 pièces d'or">
                </div>
              </div>
            </section>
          ...
          <div class="generator-actions">
            ...
            <p>Cliquez sur le bouton ci-dessous pour générer une feuille de personnage PDF de 3 pages avec toutes les informations saisies.</p>
            
            <div class="pdf-controls">
              <button id="generate-pdf-btn" class="btn-primary btn-large">
                📋 Générer la feuille PDF
              </button>
              <button id="save-character-btn" class="btn-secondary">
                💾 Sauvegarder dans le navigateur
              </button>
              <button id="load-character-btn" class="btn-secondary">
                📁 Charger depuis le navigateur
              </button>
              <button id="clear-form-btn" class="btn-warning">
            ...
            <div class="pdf-options">
              ...
              <label class="checkbox-wrapper">
                ...
                Inclure l'historique du personnage
              </label>
              <label class="checkbox-wrapper">
                <input type="checkbox" id="include-notes" checked>
                <span class="checkmark"></span>
                Ajouter une page de notes vierges
              </label>
              <label class="checkbox-wrapper">
                <input type="checkbox" id="include-portrait">
                <span class="checkmark"></span>
                Réserver un espace pour portrait
              </label>
            </div>
          </div>
      ...
      // Setup event listeners for the character sheet functionality
      this.setupCharacterSheetEventListeners();
    ...
    setupStatCalculations() {
      // Auto-update PV and mana based on stats changes
      const updateDerivedStats = () => {
        const endurance = parseInt(document.getElementById('stat-endurance')?.value) || 10;
        const intelligence = parseInt(document.getElementById('stat-intelligence')?.value) || 10;
        const level = parseInt(document.getElementById('char-level')?.value) || 1;
        
        // Calculate max HP (base + endurance bonus + level bonus)
        const maxHp = Math.max(1, 10 + Math.floor((endurance - 10) / 2) + (level - 1) * 3);
        const maxMana = Math.max(0, Math.floor((intelligence - 10) / 2) + (level - 1));
        
        const hpMax = document.getElementById('char-pv-max');
        const manaMax = document.getElementById('char-mana-max');
        
        if (hpMax && !hpMax.dataset.userModified) {
          hpMax.value = maxHp;
        }
        if (manaMax && !manaMax.dataset.userModified) {
          manaMax.value = Math.max(0, maxMana);
        }
      };
      
      // Listen for stat changes
      ['stat-endurance', 'stat-intelligence', 'char-level'].forEach(id => {
      ...
      ['char-pv-max', 'char-mana-max'].forEach(id => {
        const element = document.getElementById(id);
        if (element) {
    ...
    setupFormManagement() {
      ...
      if (saveBtn) {
        saveBtn.addEventListener('click', () => {
          ...
          localStorage.setItem('jdr-bab-character-sheet', JSON.stringify(characterData));
          
          if (JdrApp.modules.storage && JdrApp.modules.storage.showNotification) {
            JdrApp.modules.storage.showNotification('💾 Personnage sauvegardé !', 'success');
          } else {
            alert('Personnage sauvegardé dans le navigateur !');
          }
        });
      }
      ...
      if (loadBtn) {
        loadBtn.addEventListener('click', () => {
          const savedData = localStorage.getItem('jdr-bab-character-sheet');
          if (savedData) {
            try {
              const characterData = JSON.parse(savedData);
              this.populateForm(characterData);
              
              if (JdrApp.modules.storage && JdrApp.modules.storage.showNotification) {
                JdrApp.modules.storage.showNotification('📁 Personnage chargé !', 'success');
              } else {
                alert('Personnage chargé depuis le navigateur !');
              }
            } catch (error) {
      ...
      if (clearBtn) {
        clearBtn.addEventListener('click', () => {
          if (confirm('Êtes-vous sûr de vouloir vider complètement le formulaire ?')) {
            this.clearForm();
          }
        });
      }
    ...
    collectCharacterData() {
      ...
      const fields = [
        'char-name', 'char-player', 'char-race', 'char-class', 'char-subclass',
        'char-level', 'char-exp', 'char-background',
        'stat-force', 'stat-agilite', 'stat-endurance', 'stat-intelligence', 'stat-volonte', 'stat-chance',
        'char-pv-max', 'char-pv-current', 'char-mana-max', 'char-mana-current',
        'char-armure', 'char-esquive', 'char-critique', 'char-critique-sorts', 'char-resistance',
        'char-capacites', 'char-dons', 'char-sorts',
        'char-armes', 'char-armures', 'char-objets', 'char-richesses'
      ];
      ...
      const checkboxes = ['include-background', 'include-notes', 'include-portrait'];
    ...
    populateForm(data) {
      ...
      // Trigger stat recalculations
      this.setupStatCalculations();
    },

    clearForm() {
      const form = document.querySelector('.character-sheet-generator');
      if (form) {
        // Reset all inputs
        form.querySelectorAll('input, textarea, select').forEach(element => {
          if (element.type === 'checkbox') {
            element.checked = element.id === 'include-background' || element.id === 'include-notes';
          } else if (element.type === 'number') {
            // Reset to default values
            if (element.id.startsWith('stat-')) {
              element.value = 10;
            } else if (element.id === 'char-level') {
              element.value = 1;
            } else {
              element.value = element.id.includes('current') ? 
                (element.id.includes('pv') ? 20 : 10) : 
                (element.min || 0);
            }
          } else {
            element.value = '';
        ...
        setTimeout(() => this.setupStatCalculations(), 100);
      }
    },
    ...
    setupPDFGeneration() {
      ...
      if (generateBtn) {
        generateBtn.addEventListener('click', () => {
          const characterData = this.collectCharacterData();
          this.generatePDF(characterData);
        });
      }
    },

    generatePDF(characterData) {
      // Check if jsPDF is loaded (multiple possible globals)
      ...
      try {
        ...
        // Generate the 3-page PDF
        this.createPDFPage1(doc, characterData);
        this.createPDFPage2(doc, characterData);
        this.createPDFPage3(doc, characterData);
        
        // Generate filename
        const characterName = characterData['char-name'] || 'Personnage';
        const filename = `Feuille_${characterName.replace(/[^a-zA-Z0-9]/g, '_')}.pdf`;
        
        // Save the PDF
        doc.save(filename);
        
        if (JdrApp.modules.storage && JdrApp.modules.storage.showNotification) {
          JdrApp.modules.storage.showNotification('📋 PDF généré avec succès !', 'success');
        }
    ...
    createPDFPage1(doc, data) {
      // Page 1: Character Info & Stats
      doc.setFontSize(20);
      doc.text('FEUILLE DE PERSONNAGE JDR-BAB', 105, 20, { align: 'center' });
      
      doc.setFontSize(16);
      doc.text('='.repeat(50), 105, 25, { align: 'center' });
      ...
      doc.setFontSize(10);
      doc.text(`Nom: ${data['char-name'] || 'N/A'}`, 20, y);
      doc.text(`Joueur: ${data['char-player'] || 'N/A'}`, 120, y);
      y += 8;
      
      doc.text(`Race: ${data['char-race'] || 'N/A'}`, 20, y);
      doc.text(`Niveau: ${data['char-level'] || '1'}`, 120, y);
      y += 8;
      
      doc.text(`Classe: ${data['char-class'] || 'N/A'}`, 20, y);
      doc.text(`Exp: ${data['char-exp'] || '0'}`, 120, y);
      y += 8;
      
      doc.text(`Sous-classe: ${data['char-subclass'] || 'N/A'}`, 20, y);
      y += 15;
      
      // Stats section
      doc.setFontSize(14);
      doc.text('CARACTÉRISTIQUES', 20, y);
      y += 10;
      
      doc.setFontSize(10);
      const stats = [
        ['Force', data['stat-force'] || '10'],
        ['Agilité', data['stat-agilite'] || '10'],
        ['Endurance', data['stat-endurance'] || '10'],
        ['Intelligence', data['stat-intelligence'] || '10'],
        ['Volonté', data['stat-volonte'] || '10'],
        ['Chance', data['stat-chance'] || '10']
      ];
      
      stats.forEach(([name, value], index) => {
        const x = 20 + (index % 2) * 90;
        const yPos = y + Math.floor(index / 2) * 8;
        doc.text(`${name}: ${value}`, x, yPos);
      });
      ...
      // Combat stats
      doc.setFontSize(14);
      doc.text('COMBAT & RESSOURCES', 20, y);
      y += 10;
      
      doc.setFontSize(10);
      doc.text(`PV Max: ${data['char-pv-max'] || '20'}`, 20, y);
      doc.text(`PV Actuels: ${data['char-pv-current'] || '20'}`, 120, y);
      y += 8;
      
      doc.text(`Mana Max: ${data['char-mana-max'] || '10'}`, 20, y);
      doc.text(`Mana Actuels: ${data['char-mana-current'] || '10'}`, 120, y);
      y += 8;
      
      doc.text(`Armure: ${data['char-armure'] || '2'}`, 20, y);
      doc.text(`Esquive: ${data['char-esquive'] || '5'}`, 120, y);
      y += 8;
      
      doc.text(`Critique: ${data['char-critique'] || '10'}`, 20, y);
      doc.text(`Critique Sorts: ${data['char-critique-sorts'] || '8'}`, 120, y);
      y += 8;
      
      doc.text(`Résistance Alt.: ${data['char-resistance'] || '3'}`, 20, y);
      y += 15;
      
      // Background if included
      if (data['include-background'] && data['char-background']) {
        doc.setFontSize(14);
        doc.text('HISTORIQUE', 20, y);
        y += 8;
        
        doc.setFontSize(10);
        const backgroundLines = doc.splitTextToSize(data['char-background'], 170);
        doc.text(backgroundLines, 20, y);
      }
    },

    createPDFPage2(doc, data) {
      // Page 2: Skills, Spells, Feats
      doc.addPage();
      
      doc.setFontSize(16);
      doc.text('COMPÉTENCES, DONS ET SORTS', 105, 20, { align: 'center' });
      
      let y = 40;
      
      // Capacités
      doc.setFontSize(14);
      doc.text('CAPACITÉS SPÉCIALES', 20, y);
      y += 8;
      
      doc.setFontSize(10);
      if (data['char-capacites']) {
        const capaciteLines = doc.splitTextToSize(data['char-capacites'], 170);
        doc.text(capaciteLines, 20, y);
        y += capaciteLines.length * 5 + 10;
      } else {
        y += 20;
      }
      ...
      // Dons
      doc.setFontSize(14);
      doc.text('DONS ACQUIS', 20, y);
      y += 8;
      
      doc.setFontSize(10);
      if (data['char-dons']) {
        const donsLines = doc.splitTextToSize(data['char-dons'], 170);
        doc.text(donsLines, 20, y);
        y += donsLines.length * 5 + 10;
      } else {
        y += 30;
      }
      ...
      // Sorts
      doc.setFontSize(14);
      doc.text('SORTS CONNUS', 20, y);
      y += 8;
      
      doc.setFontSize(10);
      if (data['char-sorts']) {
        const sortsLines = doc.splitTextToSize(data['char-sorts'], 170);
        doc.text(sortsLines, 20, y);
      }
    },

    createPDFPage3(doc, data) {
      // Page 3: Equipment and Notes
      doc.addPage();
      
      doc.setFontSize(16);
      doc.text('ÉQUIPEMENT ET NOTES', 105, 20, { align: 'center' });
      ...
      doc.setFontSize(10);
      if (data['char-armes']) {
        const armesLines = doc.splitTextToSize(data['char-armes'], 170);
        doc.text(armesLines, 20, y);
        y += armesLines.length * 5 + 10;
      } else {
        y += 25;
      }
      
      doc.setFontSize(14);
      doc.text('ARMURES ET PROTECTION', 20, y);
      y += 8;
      
      doc.setFontSize(10);
      if (data['char-armures']) {
        const armuresLines = doc.splitTextToSize(data['char-armures'], 170);
        doc.text(armuresLines, 20, y);
        y += armuresLines.length * 5 + 10;
      } else {
        y += 25;
      }
      
      doc.setFontSize(14);
      doc.text('OBJETS ET CONSOMMABLES', 20, y);
      y += 8;
      
      doc.setFontSize(10);
      if (data['char-objets']) {
        const objetsLines = doc.splitTextToSize(data['char-objets'], 170);
        doc.text(objetsLines, 20, y);
        y += objetsLines.length * 5 + 10;
      } else {
        y += 25;
      }
      ...
      // Richesses
      doc.setFontSize(14);
      doc.text('RICHESSES', 20, y);
      y += 8;
      
      doc.setFontSize(10);
      doc.text(data['char-richesses'] || 'Aucune richesse répertoriée', 20, y);
      y += 15;
      
      // Notes section if enabled
      if (data['include-notes']) {
        doc.setFontSize(14);
        doc.text('NOTES', 20, y);
        y += 10;
