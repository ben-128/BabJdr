      ...
      if (classArticle) {
        ...
        if (subclassCard) {
          ...
          if (editableElement) {
            ...
            // Analyze structure position instead of content
            ...
            // Determine section based on position and structure
            if (element.closest('.stats-grid')) {
              subclassEditSection = 'base';
            } else if (editableElement.tagName === 'UL' || currentIndex >= 2) {  // UL or last elements are capacites
              subclassEditSection = 'capacites';
            } else if (currentIndex === 1) {  // Usually progression is second
        ...
        if (editableElement) {
          ...
          console.log('Class structure analysis:', {
            ...
            elementTag: editableElement.tagName,
            elementClasses: editableElement.className,
            hasClassArticle: !!classArticle
          });
          
          // First editable is usually resume, rest are usually capacites
          if (currentIndex === 0) {
            classEditSection = 'resume';
          } else if (currentIndex >= 1 || editableElement.tagName === 'UL') {
