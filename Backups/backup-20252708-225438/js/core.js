  ...
  window.JdrApp = {
    ...
    async loadData() {
      try {
        ...
        const [sorts, classes, dons, objets, monstres, tablesTresors, collections, staticPagesConfig, tocStructure] = await Promise.all([
        ...
        try {
          ...
          console.log('Custom page descriptions file not found, using defaults');
          window.CUSTOM_PAGE_DESCRIPTIONS = { ...this.data.customPageDescriptions };
        }
