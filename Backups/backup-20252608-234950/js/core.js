  ...
  window.JdrApp = {
    ...
    autoEnableMJModeInDevelopment() {
      try {
        ...
        console.log(`🔍 Mode detection: Standalone = ${isStandalone}`);
        
        if (!isStandalone) {
          console.log('🛠️ Development mode detected: Auto-enabling MJ mode');
          
          // Enable MJ mode (not dev mode!) automatically in development
          if (!this.state.isMJ) {
            console.log('🎭 Activating MJ mode...');
            ...
            if (JdrApp.modules.router && JdrApp.modules.router.updateMJButtonVisual) {
              ...
              console.log('🎭 MJ mode UI updated');
              ...
              if (currentHash === '#/tables-tresors') {
                setTimeout(() => {
                  if (JdrApp.modules.router && JdrApp.modules.router.renderTablesTresorsPage) {
                    console.log('🔄 Refreshing tables-tresors page to show edit buttons');
            ...
            console.log('✅ MJ mode activated successfully');
          } else {
