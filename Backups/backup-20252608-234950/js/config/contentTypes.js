  ...
  window.ContentTypes = {
    ...
    tableTresor: {
      fields: {
        ...
        description: { type: 'textarea', label: 'Description', required: true },
        tags: { type: 'tags', label: 'Tags', required: true },
        fourchettes: { type: 'lootTable', label: 'Fourchettes', required: true }
      },
      editMapping: {
        'table-tresor-name': 'nom',
        'table-tresor-description': 'description',
        'table-tresor-tags': 'tags',
        'table-tresor-fourchettes': 'fourchettes'
      },
      identifiers: {
        name: 'nom',
        category: 'tables'
      ...
      pageType: 'single',
      filterMode: 'OR', // Mode OR pour tables de trésors (au moins un tag visible requis)
      icons: { 
        category: '💎', 
        item: '🎲',
        add: '➕',
      ...
      defaultValues: {
        ...
        description: "Description de cette table de butin.",
        tags: ["Commun"],
        fourchettes: [
          {
            min: 1,
      ...
      requiresMJ: true // Visible uniquement en mode MJ
    },
