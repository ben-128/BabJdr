...
(() => {
  ...
  class PageBuilder {
    ...
    buildIdSearchFilter() {
      return `
        <div class="id-search-filter" style="margin: 1rem 0; padding: 0.75rem; background: var(--card); border: 2px solid var(--rule); border-radius: 12px;">
          <div style="display: flex; align-items: center; gap: 1rem; flex-wrap: wrap;">
            <label for="id-search-input" style="font-weight: 600; color: var(--accent-ink); white-space: nowrap;">
              🔍 Recherche par ID :
            </label>
            <div style="display: flex; align-items: center; gap: 0.5rem; flex: 1; min-width: 200px;">
              <input 
                ...
                style="flex: 1; padding: 0.4rem; border: 1px solid var(--rule); border-radius: 6px; font-size: 0.95em; max-width: 150px;"
              >
              <button 
                id="clear-id-search" 
                class="btn small" 
                style="background: var(--bronze); color: white; padding: 0.4rem 0.8rem; white-space: nowrap; font-size: 0.9em;"
                title="Effacer la recherche et afficher tous les objets"
              >
                🔄 Tout afficher
              </button>
            </div>
          </div>
          <div id="id-search-result" style="margin-top: 0.3rem; font-size: 0.85em; color: var(--paper-muted); min-height: 1em; line-height: 1.2;">
    ...
    buildTagFilters(visibleTags, availableTags) {
      ...
      return `
        <div class="objects-tag-display" style="margin: 1rem 0; padding: 1rem; background: var(--card); border: 2px solid var(--rule); border-radius: 12px;">
          <div style="display: flex; align-items: center; gap: 1rem; flex-wrap: wrap;">
            <div class="filter-chips" style="display: flex; gap: 0.5rem; flex-wrap: wrap; width: 100%;">
              ${allFilterChips}
            </div>
          </div>
        </div>
