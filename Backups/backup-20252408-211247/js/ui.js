...
(() => {
  ...
  JdrApp.modules.ui = {
    ...
    createPageArticle(pageId, pageTitle, pageData) {
      ...
      // Use PageBuilder to generate the content
      if (window.PageBuilder) {
        const pageHTML = PageBuilder.buildStaticPage(pageId, pageData);
        article.innerHTML = pageHTML;
      } else {
        ...
        article.innerHTML = `
          ...
          <div class="page-content">
            <p>Contenu de la page ${pageTitle}. Vous pouvez éditer ce texte en mode développement.</p>
          </div>
        `;
      }
