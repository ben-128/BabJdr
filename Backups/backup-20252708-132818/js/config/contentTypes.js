...
(() => {
  ...
  window.ContentTypes = {
    ...
    monster: {
      ...
      pageDescription: {
        storageKey: 'description',
        dataSource: 'external', // Utilise un fichier JSON externe
        dataKey: 'MONSTRES_PAGE_DESC',
        defaultValue: 'Créatures, ennemis et adversaires que peuvent affronter les héros dans leurs aventures.',
        editSection: 'monster-page-description'
      },
      editMapping: {
        'monster-name': 'nom',
        'monster-tags': 'tags',
    ...
    tableTresor: {
      ...
      pageDescription: {
        storageKey: 'description',
        dataSource: 'external',
        dataKey: 'TABLES_TRESORS_PAGE_DESC',
        defaultValue: 'Tables de butin permettant de générer aléatoirement des récompenses selon les fourchettes définies. Lancez un dé 20 et consultez la table correspondante pour déterminer l\'objet obtenu.',
        editSection: 'table-tresor-page-description'
      },
      editMapping: {
