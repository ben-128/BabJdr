...
(() => {
  ...
  JdrApp.modules.ui = {
        ...
        <form id="fourchette-edit-form" style="display: flex; flex-direction: column; gap: 1rem;">
          <div style="display: flex; gap: 1rem;">
            <div style="flex: 1;">
              ...
              <input type="number" id="fourchette-min" value="${fourchette.min}" min="1" max="20" style="width: 100%; padding: 0.5rem; border: 1px solid var(--bronze); border-radius: 4px;">
            </div>
            <div style="flex: 1;">
              <label for="fourchette-max" style="display: block; margin-bottom: 0.25rem; font-weight: 600;">🎲 Valeur maximum:</label>
              <input type="number" id="fourchette-max" value="${fourchette.max}" min="1" max="20" style="width: 100%; padding: 0.5rem; border: 1px solid var(--bronze); border-radius: 4px;">
            </div>
          </div>
          
          <div>
            <label for="fourchette-objet-numero" style="display: block; margin-bottom: 0.25rem; font-weight: 600;">📦 Numéro d'objet:</label>
            <input type="number" id="fourchette-objet-numero" value="${fourchette.objet?.numero || 1}" min="1" style="width: 100%; padding: 0.5rem; border: 1px solid var(--bronze); border-radius: 4px;">
          </div>
          
          <div>
            <label for="fourchette-objet-nom" style="display: block; margin-bottom: 0.25rem; font-weight: 600;">📦 Nom de l'objet:</label>
            <input type="text" id="fourchette-objet-nom" value="${fourchette.objet?.nom || ''}" placeholder="Nom de l'objet" style="width: 100%; padding: 0.5rem; border: 1px solid var(--bronze); border-radius: 4px;">
          </div>
    ...
    saveFourchette(tableName, fourchetteIndex, modal) {
      ...
      if (!objetNom) {
        this.showNotification('Le nom de l\'objet est requis', 'error');
        return;
      }
