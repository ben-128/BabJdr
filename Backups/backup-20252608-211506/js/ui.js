  ...
  JdrApp.modules.ui = {
    ...
    setupModals() {
      ...
      JdrApp.utils.events.register('click', '.spell-link', (e) => {
        ...
        console.log('Spell link clicked:', spellName, categoryName);
      ...
      const spellsHTML = spells.map(spell => `
        <div class="spell-item" data-spell-name="${spell.name}" data-spell-category="${spell.category}">
          <div class="spell-info">
            ...
            <div class="spell-meta" style="color: ${this.getElementColor(spell.element)} !important;">${this.getElementIcon(spell.element)} ${spell.element} • ${spell.category}</div>
      ...
      popup.innerHTML = `
        <div class="spell-preview-content">
          <div class="spell-preview-header" style="border-left: 4px solid ${elementColor};">
            ...
            <div class="spell-element" style="color: ${elementColor} !important;">${this.getElementIcon(spellData.element)} ${spellData.element} • ${categoryName}</div>
