...
(() => {
  ...
  class TablesTresorsManager {
    ...
    init() {
      ...
      console.log('📊 TablesTresorsManager initialized');
    }
    ...
    saveFourchette() {
      try {
        ...
        if (isNewFourchette) {
          ...
          console.log('Mode modification - non implémenté complètement dans cette demo');
        }
        ...
        console.log('Fourchette sauvegardée avec succès');
    ...
    deleteFourchette(tableName, fourchetteIndex) {
      ...
      try {
        ...
        console.log('Fourchette supprimée avec succès');
