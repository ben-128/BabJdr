...
(() => {
  ...
  JdrApp.modules.ui = {
    ...
    showTableTresorTagsManagement() {
      ...
      } else if (window.ContentTypes?.tableTresor?.filterConfig?.availableTags) {
        availableTags = window.ContentTypes.tableTresor.filterConfig.availableTags;
      } else {
    ...
    setupTableTresorTagsModalEvents(modal, availableTags) {
      ...
      const addTag = () => {
        ...
        if (newTag && !availableTags.includes(newTag)) {
          ...
          // Also update ContentTypes as backup if available
          if (window.ContentTypes?.tableTresor?.filterConfig) {
            window.ContentTypes.tableTresor.filterConfig.availableTags = [...availableTags];
          }
