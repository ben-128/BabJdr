...
(() => {
  ...
  const _eclatsPath = _resolveImg('data/images/Autre/stats/éclats.png');
  window.EclatsIcon = {
    url: _eclatsPath,
    small: \`<img src="\${_eclatsPath}" alt="éclats" class="eclats-icon" style="width: 16px; height: 16px; vertical-align: middle;">\`,
    medium: \`<img src="\${_eclatsPath}" alt="éclats" class="eclats-icon" style="width: 24px; height: 24px; vertical-align: middle;">\`,
    large: \`<img src="\${_eclatsPath}" alt="éclats" class="eclats-icon" style="width: 32px; height: 32px; vertical-align: middle;">\`
  };
