    ...
    try {
      ...
      let html = `
        <div style="line-height: 1.6;">
          ...
          <p>Élément: ${this.calculatedCharacter.element}</p>
          <br>
          <hr style="border: none; border-top: 2px solid var(--gold); margin: 1.5rem 0;">
          <p><strong>CARTE DU DESTIN</strong></p>
          ...
          <p>Coordination: ${this.calculatedCharacter.competences.Coordination} | Réflexion: ${this.calculatedCharacter.competences.Réflexion}</p>
          <p>Eloquence: ${this.calculatedCharacter.competences.Eloquence}</p>
          <br>
          <p><strong>DONS</strong></p>
          ${this.getDonsListHTML()}
          <br>
          <p><strong>CAPACITÉS DE CLASSE</strong></p>
          ${this.getCapacitesHTML()}
          ${this.getSortsHTML()}
          <br>
          <p><strong>ÉQUIPEMENT</strong></p>
          ${this.getEquipmentListHTML()}
          <p style="margin-top: 0.5rem;"><strong>Budget restant:</strong> ${this.currentConfig.budgetEclats} éclats</p>
        </div>
      `;
